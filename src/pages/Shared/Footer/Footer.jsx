...
import VisitCount from "../../../omponents/VisitCount";
  ...
  return (
    <div className="container mx-auto">
      <footer className="footer p-10 bg-base-300 text-base-content">
        <aside>
          <img className="w-24" src="https://i.postimg.cc/DzMGJPTd/altlogo.png" alt="Alt Products Logo" />
          <p className="font-semibold text-blue-500">
            <span className="text-2xl font-bold text-blue-600">The Alt Products</span><br />Find Your Alternative Products
          </p>
        </aside>
        <nav>
          <h6 className="footer-title text-blue-600">Explore</h6>
        ...
        <nav>
          <h6 className="footer-title text-blue-600">Services</h6>
        ...
        <nav>
          <h6 className="footer-title text-blue-600">Get in touch</h6>
      ...
      <p className="text-sm font-semibold text-blue-600 bg-base-300 text-center pb-5">Copyright © 2024 - All right reserved by The Alt Products</p>
    </div>
  );
};
