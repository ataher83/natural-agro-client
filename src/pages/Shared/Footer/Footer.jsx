...
const Footer = () => {
  ...
  return (
    <div className="container mx-auto">
      <footer className="footer p-10 bg-base-300 text-base-content">
        <aside>
          ...
          <p className="font-semibold text-green-500">
            <span className="text-2xl font-bold text-green-600">Natural Agro</span><br />Pure Harvest, Naturally Grown
          </p>
        </aside>
        <nav>
        ...
        <nav>
          ...
          <a className="link link-hover">Natural Agro</a>
          <a className="link link-hover">123 XYZ Road, Dhaka</a>
          <a className="link link-hover">Tel: 01100-000000</a>
          <a className="link link-hover">Email: hello@naturalagro.com</a>
        </nav>
        <nav>
      ...
      <p className="text-sm font-semibold text-green-600 bg-base-300 text-center pb-5">Copyright © 2024 - All right reserved by Natural Agro</p>
    </div>
  );
};
